...
xxxpy_spec = ["implementation_id", "XXXpy", 
		 "type_name",         "XXXpy", 
...
# 
# 
class XXXpy(OpenRTM_aist.DataFlowComponentBase):
	...
	def onInitialize(self):
		...
		self._MyServidePort.registerProvider("myservice0", "SimpleService::MyService", self._myservice0)
...
def XXXpyInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=xxxpy_spec)
...
def MyModuleInit(manager):
    ...
    # Create a component
    comp = manager.createComponent("XXXpy")
